...
const getResponse = (input, knowledge, lang, services) => {
  ...
  if (knowledge.locationKeywords.some(k => text.includes(k.normalize('NFD').replace(/[\u0300-\u036f]/g, '')))) {
    return {
      text: es
        ? '📍 Nos encontramos en **Carrer Major, 42, 08470 Sant Celoni, Barcelona**. Fácil acceso en transporte público y parking cercano.'
        : '📍 Estem a **Carrer Major, 42, 08470 Sant Celoni, Barcelona**. Fàcil accés en transport públic i aparcament proper.',
